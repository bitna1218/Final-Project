...
<section class="container" style="height: 1100px;">
	<div  style="text-align: center; position: relative; right: 230px;" id="list">
        ...
        <div class="panel-body">  	
                	...
                	<c:forEach items="${Passlatter}" var="board">
                    	<tr class="odd gradeX">
                            ...
                            <td><a class="move" style="text-decoration: none; color: black;" 
                            	   href='/board/user/Passlatter/reg-detail?bno=<c:out value="${board.bno }"/>'>
            ...
            <div class='row'>
            	<div class="col-lg-12">
                	<form id='searchForm' action="/board/user/Passlatter/community" method="get">
                    	<select name='type'>
                        	<option value=""
        ...
        <form id="actionForm" action="/board/user/Passlatter/community" method='get'>
...
<script type="text/javascript">
	...
	function goPost(Views){
		...
		p.setAttribute('action','/board/user/Passlatter/community');
		...
		p2.setAttribute('action','/board/user/Passlatter/community');
	...
	function goPost2(Likes){
		...
		p.appendChild(obj);
		p.setAttribute('method','post');
		p.setAttribute('action','/board/user/Passlatter/community2');
		document.body.appendChild(p); 
		...
		p2.appendChild(obj2);
		p2.setAttribute('method','post');
		p2.setAttribute('action','/board/user/Passlatter/community2');
		document.body.appendChild(p2);
		p2.submit(); 
...
$(document).ready(function () {	
	...
	$("#regBtn").on("click", function () {
		self.location = "/board/user/Passlatter/reg";
	});
