...
<body class="container">
	<br>
	<br>
	<form id="register-form" action="/board/user/WorryQnA/regQnA" method="post">
		<div>
			<select style="border-radius: 5px; background: rgb(62, 146, 144); color:white; position: relative; left: 60px;" name="select">
  			...
  			<select style="border-radius: 5px; background: rgb(62, 146, 144); color:white; position: relative; left: 60px;" name="select2">
